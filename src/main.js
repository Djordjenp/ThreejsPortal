...
gltfLoader.load(
    "../resources/portal2.glb",
    (gltf) => {
        const bakedMesh = gltf.scene.children.find(child => child.name === 'baked')
        const poleLightA = gltf.scene.children.find(child => child.name === 'Cube014')
        const poleLightB = gltf.scene.children.find(child => child.name === 'Cube011')
...
window.addEventListener('resize', () =>
{
    ...
    firefliesMaterial.uniforms.uPixelRatio = Math.min(window.devicePixelRatio, 2)
})
